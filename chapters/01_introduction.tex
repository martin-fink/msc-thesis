...
Recent advancements in hardware, such as ARM's \ac{PAC}~\cite{Qualcomm2017PointerAuth} and \acf{MTE}~\cite{ARM2019MTE}, offer promising, high-performance solutions by providing building blocks with low overhead.
