...
In \todo{ref:fig\_design\_bounds\_checks}, we showcase an approach that utilizes memory tagging to replace traditional bounds checks in wasm64 environments.
