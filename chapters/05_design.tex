...
In both models, we depict trusted components (marked with a \raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/trusted}}) in green and untrusted components (marked with a \raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/untrusted}}) in red.
We additionally highlight the component we are trying to harden (marked with a \raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/poi}}).
