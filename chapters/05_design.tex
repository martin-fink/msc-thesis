...
In both models, we depict trusted components (\raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/trusted}}) in green and untrusted components in red (\raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/untrusted}}).
We additionally highlight the point of interest with a sightglass symbol (\raisebox{-0.25em}{\includegraphics[clip,height=1em]{./figures/build/poi}}).
