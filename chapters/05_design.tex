...
On the left-hand side of the reduction for instruction $i$, we list the top of the operand stack and the state $s$.
On the right-hand side, we show the resulting state and operand stack after executing the instruction $i$.
